...
/**
  ...
  */
#define SD_DETECT_PIN                    GPIO_Pin_9                 /* PI.9 */
...
#define sEE_I2C_SCL_PIN                  GPIO_Pin_4                  /* PB.06 */
#define sEE_I2C_SCL_GPIO_PORT            GPIOH                       /* GPIOB */
#define sEE_I2C_SCL_GPIO_CLK             RCC_AHB1Periph_GPIOH
#define sEE_I2C_SCL_SOURCE               GPIO_PinSource4
#define sEE_I2C_SCL_AF                   GPIO_AF_I2C2
#define sEE_I2C_SDA_PIN                  GPIO_Pin_5                  /* PB.09 */
#define sEE_I2C_SDA_GPIO_PORT            GPIOH                       /* GPIOB */
#define sEE_I2C_SDA_GPIO_CLK             RCC_AHB1Periph_GPIOH
